      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-12 text-neutral-400 hover:text-white transition-colors"
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-12 text-neutral-400 hover:text-white transition-colors"
